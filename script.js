const memories = [
    ...
    {
        text: "Toen we erachter kwamen dat het stukje van je tand oplicht in blacklight",
    ...
    {
        text: "Toen we blackstories via videobellen probeerden te spelen, alleen mijn antwoorden waren flut volgensmij",
    ...
    {
        text: "Onze alle eerste foto met zijn 2en, aan het begin van onze date",
